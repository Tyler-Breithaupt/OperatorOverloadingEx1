...
namespace OperatorOverloadingEx1
{
    public class Calculator
    {
        ...
        public static Calculator operator ++(Calculator operand)
        {
            operand.number++;
            return operand;
        }
        ...
        public static bool operator >(Calculator operand1, Calculator operand2)
        {
        ...
        public static Calculator operator +(Calculator operand1, Calculator operand2)
        {
